...
function ai_help
    ...
    echo "  ai --reasoning \"prompt\"   Show step-by-step reasoning before answer"
    echo "  ai --think \"prompt\"       Same as --reasoning (alias)"
    ...
    echo "  ai --reasoning \"solve this math problem: 2x + 5 = 15\""
    echo "  ai --think \"what's the best approach for this?\""
